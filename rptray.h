...
public:
    ...
    CRPTray::CRPTray(void)
    {
	    ...
	    m_nid.hIcon         = (HICON) ::LoadImage(_Module.GetResourceInstance(), MAKEINTRESOURCE(IDI_ICON), IMAGE_ICON, ::GetSystemMetrics(SM_CXICON), ::GetSystemMetrics(SM_CYICON), LR_DEFAULTCOLOR);
        m_nid.hWnd          = m_hWnd;
        m_nid.uID           = 0;
    ...
    void Ballon(WTL::CString &message, UINT timeout)
    {
        ...
        m_nid.dwInfoFlags   = NIF_MESSAGE | NIF_ICON | NIF_TIP | NIIF_USER;
